...
const Mycard = () => {
    return (
          <div className="card mt-5 ms-5" style={{ border: 'none'}}>
            <div className="row">

      <div className="row justify-content-center align-items-center"> {/* Center the row vertically and horizontally */}
        <div className="col"> {/* Adjust column width */}
            <div id="carouselExampleAutoplaying" className="carousel slide" style={{ width: '100%', maxWidth:'100vw', height: '400px' }} data-bs-ride="carousel">
...
<div className="row mt-5 ms-5">
  ...
  <div className="col-12 col-md-4 mb-4">
    {/* First Card */}
    <div className="card p-3" style={{ width: '400px', height: '500px' }}>
